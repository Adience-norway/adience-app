const no: {
  ...
  minSide: {
    ...
    geofence: {
      ...
      modeSirkel: "Sirkel",
      modePolygon: "Polygon",
      polygonMaxHint: "Klikk i kartet for å legge til punkter, dra for å justere. Konturen kan ikke strekke seg mer enn 2000 m fra arenaens registrerte posisjon.",
      polygonSaveButton: "Lagre polygon",
  ...
  admin: {
    ...
    detailPanel: {
      ...
      globalGeofenceValue: "Ingen grense (global)",
      globalGeofenceHint: "Denne arenaen skal kunne testes fra hvor som helst i verden — bl.a. av Apple under App Store-vurdering. Ingen geofence-begrensning.",
      globalGeofenceUnlock: "Lås opp for å endre",
      globalGeofenceRestore: "Gjenopprett global dekning (ingen grense)",
